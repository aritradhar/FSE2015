...
sensitive sources and sinks, and exclude specific tainted paths. \ignore{In the
default behavior of \tool\ we took a safe assumption that patched objects which
are leaving the system may cause some unintended behavior in some other
modules.} \note{Rephrased and compressed. Made minor edits --- md}
