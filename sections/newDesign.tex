...
phase identifies all declarative constraints.
...
\myparagraph{Dynamic constraint collection}: The constraint set is populated at
the end of the static phase, and \tool\ leverages
...
\code{RuntimeException}, it is possible that a statement may throw both
...
facilitates exception-specific repairing as well.
...
of program repair, and leave comparison of different solvers for future work.
