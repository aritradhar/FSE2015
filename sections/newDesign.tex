...
\code{String} objects. \textcolor{red}{The definition of
...
exceptions. \textcolor{red}{We leverage constraint propagation technique to make
...
\code{String} objects throughout the program.}
...
will looks like~\ref{snippet:exCode2}. \textcolor{red}{One complex example of
