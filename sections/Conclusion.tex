...
%% Therefore, it is hardly a surprise that automatic program repairing has been
%% an actively researched area over the past decade.
...
%% Motivated by the results of our study as well as by the research conducted by
%% other researchers, we intend to extend \tool\ in the future by adding support
%% for other \java\ APIs and also by adding more intelligence to the process of
%% patch generation.
