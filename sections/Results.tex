...
v$2.5.0$ for bytecode analysis and instrumentation, and \soot\ \infoflow\
snapshot from May'14 for static taint analysis.
...
control flow using the \textbf{Flow Consistency Index (FCI)} which is calculated
...
required \tool\ to ignore at most one exception.
