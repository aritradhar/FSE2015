...
$16$ & $2$ & $18$ & $0$ & $0.588$ &$0$ & $168$& $8$ & $\checkmark$ \\

\code{Commons Math} & \cite{MATH198} & Major & $3.4K$ & $300$ & 
$19$ & $2$ & $21$ & $0$ & $0.892$ &$1$ & $36$ &$2$ & $\checkmark$ \\
...
$30$ & $2$ & $22$ & $0$ & $0.459$ &$0$ & $47$ & $6$ & $\checkmark$ \\
...
$14$ & $2$ & $16$ & $0$ & $0.869$ &$0$ & $6$ & $1$ &$\checkmark$ \\

\code{FlexDK 3.4} &\cite{SDK14417} & Minor & $6.3K$ & $600$ & 
$13$ & $2$ & $15$ & $0$ & $0.743$ &$0$ & $207$ & $25$& $\checkmark$ \\
...
$24$ & $1$ & $25$ & $0$ & $0.826$ &$0$ & $13$ & $2$ & $\checkmark$ \\
...
$28$ & $1$ & $29$ & $0$ & $0.854$ &$0$ & $10$ & $2$ & $ \checkmark$ \\
...
$20$ & $3$ & $26$ & $0$ & $0.452$ &$1$ & $6$ &$1$ & $\checkmark$ \\
...
and then applied \tool\ to patch it. We observed that \tool\ successfully
patched the offending class file in $28$ of the $30$ library benchmarks in our
data set, \ie\ an effectiveness of $93.33$\%.

Note that even the patched versions of \code{Eclipse AJ Weaver} and \code{Hive}
benchmarks fail their corresponding test cases. We observed that for
\code{Eclipse AJ Weaver}, the \todo{add the reason.}. In case of \code{Hive},
the \todo{add the reason.}
...
fix, the PQI will be lesser. Thus, a higher value of PQI, \ie\ closer to $1$,
is preferred. PQI values greater than $1$ mean that \tool\ generates many more
constraints than reflected in the developer's fix, while low values of PQI
suggest that \tool\ may misses out on several constraints.

PQI can be computed automatically, since \tool\ already generates a list of
constraints (in the form of Jimple bytecodes), and static program analysis of
the developer's patch can provided the same. However, in our current
implementation, we compute the constraints for the developer's fix through
manual inspection of the Jimple bytecodes. Table~\ref{tab:results} lists the PQI
for the benchmarks in our set. We note that PQI is $>$$0.7$ for over $70\%$ of
the benchmarks. This high PQI across several benchmarks indicates two things:
...
fixes errors in several of these \code{String} operations. 
