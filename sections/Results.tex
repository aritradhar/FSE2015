...
\hfill
&
\subfloat[Variation in instrumentation time with \code{Units}
instrumented.\label{figure:perf:strings}]
...
constraints for the benchmarks used in our data set. We observe that 

\item \textbf{Instrumentation overhead}:
