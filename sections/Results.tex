...
with all optimizations enabled successfully patched the offending bug in $29$
of the $30$ library benchmarks in our data set (see column $\mathcal{F}_{P}^{*}$
in Table~\ref{tab:results}), thereby achieving an effectiveness of over $96$\%.
