...
Cascaded exception exists &$\mathcal{N}_{Unit}$ & \# \code{Units} analyzed\\

$FCI$ & Flow Consistency
Index & $\mathcal{IC}_{WO}$ & Instrumentation w/ optimization
(recall \xref{subsec:optimizations}) & $\mathcal{S}_{U}$ & \#successful test
cases in unpatched & $\mathcal{F}_{U}$ & \#fail test cases in unpatched \\

$\mathcal{S}_{P}$ & \#successful test cases in patched version &
$\mathcal{F}_{P}$ & \#fail test cases in patched version & & &&\\
