...
\multicolumn{1}{c|}{\textbf{$\mathcal{IC}_O$}} & %instrumentation with optimization
\multicolumn{1}{c|}{\textbf{$\mathcal{IC}_{UO}$}} & %instrumentation without optimization
...
bugs related to \java\ \code{String} API. We have used
