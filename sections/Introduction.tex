...
illustrate the proposed approach. Section~\ref{sec:SystemDesign} provides the architecture of \texttt{Clotho} and describes the
analyses implemented by the tool. Section~\ref{sec:implementation} provides implementation details and Section~\ref{sec:results}
presents the results of the study. Finally, Section~\ref{sec:relatedWork} presents the related work and Section~\ref{sec:conc} concludes
