...
\begin{mylist}
\item We describe a technique (\xref{sec:motivation} and \xref{sec:tool}) that
...
unhandled runtime exceptions from \java\ \code{String} APIs.
The results (\xref{sec:results}) of our study indicate that \tool\ can effectively produce
