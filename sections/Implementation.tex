...
repairing strategy on the \java\ \code{String} API as it is one of the most
frequent used APIs in commercially available \java\ applications and libraries.
Another reason to choose \code{String} API was that we have found plenty of
bugs related to \code{String} in some of the popular libraries and applications
