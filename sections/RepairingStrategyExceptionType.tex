...
As the error occurred at the line \code{int\ temp5\ =\ this.arr3[temp3];} the
statements which produces the \code{temp3} and the statement which also involves
\code{temp3} or any other variables derived from \code{temp3}, would be included
