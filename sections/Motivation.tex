...
failure, \ie\ $\mathcal{B}'_{{I_f}_c}$ is same as the intended behavior $\mathcal{B}_{{I_f}_c}$.
...
set two more goals associated with the security and performance of the technique.
