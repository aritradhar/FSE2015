...
% For author table --- md
% \renewcommand{\and}{\hspace{5mm}}
\def\sharedaffiliation{%
\end{tabular}
\begin{tabular}{c@{\hskip 0.75in}c@{\hskip 0.75in}c}}

\def\ibm{\raisebox{6pt}{\small \ding{67}}}
\def\xrci{\raisebox{6pt}{\small \ding{82}}}
\def\iiit{\raisebox{6pt}{\small \ding{81}}}